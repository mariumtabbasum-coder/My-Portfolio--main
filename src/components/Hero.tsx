      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            {/* Top Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-50 dark:bg-cyan-950/60 border border-cyan-200/70 dark:border-cyan-800/60 text-cyan-800 dark:text-cyan-300 text-xs font-semibold mb-6 shadow-2xs">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-cyan-500"></span>
              </span>
              <span>Aptech Software Engineering & Bano Qabil AI Scholar</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto lg:mx-0 mb-8 leading-relaxed">
              Hi, I'm <strong className="text-slate-900 dark:text-white font-semibold">Marium Tabassum</strong> — a passionate Software Engineering student at Aptech (Semester 1 complete) and Generative AI Scholar at Bano Qabil. I build responsive frontend apps and integrate Google Gemini API workflows.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3.5 mb-10">
              <a
                href="#ai-lab"
                className="px-6 py-3.5 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 hover:from-cyan-700 hover:via-blue-700 hover:to-indigo-700 shadow-md shadow-blue-500/25 transition-all hover:scale-[1.02] active:scale-98 flex items-center gap-2 group"
              >
                <Sparkles className="w-4 h-4 text-cyan-200 group-hover:rotate-12 transition-transform" />
                <span>Explore Live AI Lab</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>

              <a
                href="#projects"
                className="px-6 py-3.5 rounded-xl font-bold text-sm text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/80 shadow-2xs transition-all hover:scale-[1.02]"
              >
                View Projects
              </a>
          ...
          <div className="lg:col-span-5">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="rounded-3xl p-6 sm:p-7 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 shadow-xl shadow-slate-200/40 dark:shadow-black/40">
                ...
                <div className="my-5 space-y-3">
                  ...
                  <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-xs font-bold text-slate-900 dark:text-white">
                        Bano Qabil Gen AI Scholar
                      </div>
                      <div className="text-[11px] text-slate-500 dark:text-slate-400">
                        Generative AI Fundamentals & Prompting
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 text-slate-200 font-mono text-[11px] leading-relaxed border border-slate-800">
                  ...
                  <p><span className="text-cyan-400">const</span> <span className="text-blue-300">focus</span> = [<span className="text-amber-300">"Frontend Engineering"</span>, <span className="text-amber-300">"GenAI APIs"</span>];</p>
                  <p><span className="text-cyan-400">const</span> <span className="text-blue-300">status</span> = <span className="text-emerald-300">"Ready for new challenges"</span>;</p>
                </div>
